...
var jn = V(() => {
  ...
  Sr = (t, e) => {
    ...
    var _a;
    let r = ((_a = new Error().stack) == null ? void 0 : _a.split(/\r\n|\r|\n/g)) || [], n = false;
...
var cs = V(() => {
  ...
  vt();
  Cr();
  us = "ort-wasm-proxy-worker", ds = ((_a = globalThis.self) == null ? void 0 : _a.name) === us;
  ds && (self.onmessage = (t) => {
...
async function ps(t = {}) {
  var _a2, _b;
  var e = t, r = !!globalThis.window, n = !!globalThis.WorkerGlobalScope, o = n && ((_a2 = self.name) == null ? void 0 : _a2.startsWith("em-pthread"));
  ...
  let i = (a) => async (...l) => {
    ...
    try {
      ...
      (_a3 = e.gd) == null ? void 0 : _a3.flush();
      let _ = h.errors;
      if (0 < _.length) {
...
`));
  ...
  async function Se() {
    ...
    }) : o ? a(new WebAssembly.Instance(b, X()), b) : (ie ?? (ie = e.locateFile ? e.locateFile ? e.locateFile("ort-wasm-simd-threaded.jsep.wasm", m) : m + "ort-wasm-simd-threaded.jsep.wasm" : new URL("ort-wasm-simd-threaded.jsep.wasm", import.meta.url).href), l = await async function(f) {
      var _ = ie;
      if (!g && !z(_)) try {
...
`))[0] == "Error" && f.shift(), Ci(f);
  ...
  var On, zn = {}, Ai = () => {
    var _a3;
    if (!On) {
      var a, l = { USER: "web_user", LOGNAME: "web_user", PATH: "/", PWD: "/", HOME: "/home/web_user", LANG: (((_a3 = globalThis.navigator) == null ? void 0 : _a3.language) ?? "C").replace("-", "_") + ".UTF-8", _: "./this.program" };
  ...
  function vr() {
    if (0 < Ce) $e = vr;
      ...
      0 < Ce ? $e = vr : (e.calledRun = true, A || (re(), w == null ? void 0 : w(e)));
    }
  }
...
var fs = V(() => {
  "use strict";
  var _a, _b;
  xf = ps, Sf = (_b = (_a = globalThis.self) == null ? void 0 : _a.name) == null ? void 0 : _b.startsWith("em-pthread");
  Sf && ps();
});
var ys;
var Xn;
...
var vt = V(() => {
  ...
  eo = false, Mr = false, $s = false, Ef = () => {
    ...
    let o = t.wasmPaths, i = typeof o == "string" ? o : void 0, s = o == null ? void 0 : o.mjs, u = (s == null ? void 0 : s.href) ?? s, d = o == null ? void 0 : o.wasm, c = (d == null ? void 0 : d.href) ?? d, p = t.wasmBinary, [m, g] = await vs(u, i, r > 1, !!p || !!c), b = false, y = [];
...
var Ss = V(() => {
  ...
  xs = (t) => {
    ...
    try {
      ...
      let i = 0;
      return (t == null ? void 0 : t.tag) !== void 0 && (i = We(t.tag, n)), r = e._OrtCreateRunOptions(o.logSeverityLevel, o.logVerbosityLevel, !!o.terminate, i), r === 0 && me("Can't create run options."), (t == null ? void 0 : t.extra) !== void 0 && er(t.extra, "", /* @__PURE__ */ new WeakSet(), (s, u) => {
  ...
  Os = /* @__PURE__ */ new Map([["float32", 32], ["float16", 16], ["int32", 32], ["uint32", 32], ["int64", 64], ["uint64", 64], ["int8", 8], ["uint8", 8], ["int4", 4], ["uint4", 4]]), ao = (t, e) => {
    ...
    async download(e) {
      ...
      if (this.activeUpload) {
        let r = ((_a = this.wrapper) == null ? void 0 : _a.isDataConverted) ? zs(this.activeUpload, (_b = this.wrapper) == null ? void 0 : _b.type) : this.activeUpload;
        if (e) {
...
var Ws = V(() => {
  ...
  Us = /* @__PURE__ */ new Map([[64, 250], [128, 200], [256, 200], [512, 200], [2048, 230], [4096, 200], [8192, 50], [16384, 50], [32768, 50], [65536, 50], [131072, 50], [262144, 50], [524288, 50], [1048576, 50], [2097152, 30], [4194304, 20], [8388608, 10], [12582912, 10], [16777216, 10], [26214400, 15], [33554432, 22], [44236800, 2], [58982400, 6], [67108864, 6], [134217728, 6], [167772160, 6]]), so = [], uo = (t) => Math.ceil(Number(t) / 16) * 16, Wf = (t) => {
    ...
    get(e) {
      var _a;
      return (_a = this.storageCache.get(e)) == null ? void 0 : _a.gpuData;
    }
    release(e) {
...
var St = V(() => {
  ...
  Ze = (t, e, r = "f32") => {
    ...
    if (e === "HardSigmoid") {
      ...
      let [r, n] = (t == null ? void 0 : t.activation_params) || [Es, ks];
...
var rl = V(() => {
  ...
  Co = "[a-zA-Z]|\\.\\.\\.", dn = "(" + Co + ")+", Xd = "^" + dn + "$", ag = "(" + dn + ",)*" + dn, sg = "^" + ag + "$", Ao = class {
    ...
    constructor(e, r) {
      ...
      (_a = o.match(RegExp(Co, "g"))) == null ? void 0 : _a.forEach((u) => {
    ...
    let i = t.map((p) => p.length).map((p, m) => O(`input${m}`, e, p)), s = k.size(n), u = R("output", e, n.length), d = [...r.symbolToInfo.keys()].filter((p) => !r.rhs.symbolToIndices.has(p)), c = (p) => {
      ...
      r.symbolToInfo.forEach((E, A) => {
        ...
        if (r.rhs.symbolToIndices.has(A)) {
          let z = (_a = r.rhs.symbolToIndices.get(A)) == null ? void 0 : _a[0];
...
`)};
    ...
    return { name: "Einsum", shaderCache: { hint: r.equation, inputDependencies: t.map(() => "rank") }, getRunData: () => {
      let p = d.filter((g) => r.symbolToInfo.has(g)).map((g) => {
        var _a;
        return { type: 12, data: ((_a = r.symbolToInfo.get(g)) == null ? void 0 : _a.dimValue) || 0 };
      });
...
var Dl = V(() => {
  ...
  `;
    ...
    if (((_a = t.inputs[1]) == null ? void 0 : _a.dims.length) === 5) throw new Error("Packed KV is not implemented");
...
var Lc = V(() => {
  ...
  Wy = (t, e) => {
    ...
    var _a, _b;
    let n = t.name;
    return ((_a = t.shaderCache) == null ? void 0 : _a.hint) && (n += "[" + t.shaderCache.hint + "]"), n += ":" + r + `:${Wy(e, ((_b = t.shaderCache) == null ? void 0 : _b.inputDependencies) ?? new Array(e.length).fill("dims"))}`, n;
  }, Do = class {
    constructor(e) {
    ...
    flush() {
      ...
      this.queryType !== "none" && (this.commandEncoder.resolveQuerySet(this.querySet, 0, this.pendingDispatchNumber * 2, this.queryResolveBuffer, 0), e = this.device.createBuffer({ size: this.pendingDispatchNumber * 2 * 8, usage: GPUBufferUsage.MAP_READ | GPUBufferUsage.COPY_DST }), this.pendingQueries.set(e, this.pendingKernels), this.pendingKernels = [], this.commandEncoder.copyBufferToBuffer(this.queryResolveBuffer, 0, e, 0, this.pendingDispatchNumber * 2 * 8)), this.device.queue.submit([this.commandEncoder.finish()]), this.gpuDataManager.refreshPendingBuffers(), this.commandEncoder = null, this.pendingDispatchNumber = 0, this.queryType !== "none" && e.mapAsync(GPUMapMode.READ).then(() => {
        ...
        for (let o = 0; o < r.length / 2; o++) {
          ...
          if ((_a = this.env.webgpu.profiling) == null ? void 0 : _a.ondata) this.env.webgpu.profiling.ondata({ version: 1, inputsMetadata: m.map((x) => ({ dims: x.dims, dataType: rt(x.dataType) })), outputsMetadata: g.map((x) => ({ dims: x.dims, dataType: rt(x.dataType) })), kernelId: s, kernelType: d, kernelName: c, programName: p, startTime: w, endTime: S });
          else {
            let x = "";
            m.forEach((T, I) => {
...
var Gc = V(() => {
  ...
  sr = class t {
    ...
    compute(e, r) {
      var _a;
      let n = ((_a = r == null ? void 0 : r.inputs) == null ? void 0 : _a.map((u) => typeof u == "number" ? this.inputs[u] : u)) ?? this.inputs, o = (r == null ? void 0 : r.outputs) ?? [], i = (u, d, c) => new sr(this.module, d, this.output(u, c), c), s = (u, d) => {
        let c = xt(u, d);
...
var Qn = V(() => {
  ...
  Fy = (t, e) => {
    ...
    var _a, _b;
    (_b = (_a = ge()).asyncInit) == null ? void 0 : _b.call(_a);
    ...
    try {
      if ([s, d] = await Ts(e), (e == null ? void 0 : e.externalData) && o.mountExternalData) {
        let I = [];
      ...
      for (let I of (e == null ? void 0 : e.executionProviders) ?? []) if ((typeof I == "string" ? I : I.name) === "webnn") {
        if (o.shouldTransferToMLTensor = false, typeof I != "string") {
          let A = I, z = A == null ? void 0 : A.context, v = A == null ? void 0 : A.gpuDevice, M = A == null ? void 0 : A.deviceType, N = A == null ? void 0 : A.powerPreference;
      ...
      i = await o._OrtCreateSession(r, n, s), (_a = o.webgpuOnCreateSession) == null ? void 0 : _a.call(o, i), i === 0 && me("Can't create a session."), (_b = o.jsepOnCreateSession) == null ? void 0 : _b.call(o), o.currentContext && (o.webnnRegisterMLContext(i, o.currentContext), o.currentContext = void 0, o.shouldTransferToMLTensor = true);
    ...
    let [n, o, i, s, u] = r;
    s && (u && e._OrtClearBoundOutputs(s.handle) !== 0 && me("Can't clear bound outputs."), e._OrtReleaseBinding(s.handle) !== 0 && me("Can't release IO binding.")), (_a = e.jsepOnReleaseSession) == null ? void 0 : _a.call(e, t), (_b = e.webnnOnReleaseSession) == null ? void 0 : _b.call(e, t), (_c2 = e.webgpuOnReleaseSession) == null ? void 0 : _c2.call(e, t), o.forEach((d) => e._OrtFree(d)), i.forEach((d) => e._OrtFree(d)), e._OrtReleaseSession(n) !== 0 && me("Can't release session."), Mt.delete(t);
    ...
    try {
      ...
      if (g && !y) {
        ...
        for (let Z = 0; Z < S; Z++) {
          let te = n[Z];
          ((_a = o[Z]) == null ? void 0 : _a[3]) ? (A.push(I[Z]), s._OrtBindOutput(W, m[te], I[Z], 0) !== 0 && me(`Can't bind pre-allocated output[${Z}] for session=${t}.`)) : s._OrtBindOutput(W, m[te], 0, Y[te]) !== 0 && me(`Can't bind output[${Z}] to ${j[Z]} for session=${t}.`);
        }
      ...
      (_d2 = s.webnnOnRunEnd) == null ? void 0 : _d2.call(s, c), s.stackRestore(z), T.forEach((q) => s._OrtReleaseTensor(q)), I.forEach((q) => s._OrtReleaseTensor(q)), E.forEach((q) => s._free(q)), x !== 0 && s._OrtReleaseRunOptions(x), $.forEach((q) => s._free(q));
    }
  }, Dr = (t) => {
    let e = ge(), r = Mt.get(t);
  ...
  Rt = () => !!ye.wasm.proxy && typeof document < "u", ur = false, hn = false, gn = false, Uo = /* @__PURE__ */ new Map(), Ft = (t, e) => {
    ...
    if (!hn) {
      ...
      if (ur = true, Rt()) return new Promise((t, e) => {
        He == null ? void 0 : He.terminate(), _s().then(([r, n]) => {
          try {
...
export {
  vf as InferenceSession,
  Sr as TRACE,
  wt as TRACE_EVENT_BEGIN,
  _t as TRACE_EVENT_END,
  Ne as TRACE_FUNC_BEGIN,
  Me as TRACE_FUNC_END,
  Ke as Tensor,
  sT as default,
  ye as env,
  kt as registerBackend
};
